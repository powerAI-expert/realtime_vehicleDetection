...
mainFilename = 'C:\\Users\MBA\Desktop\mainFileVehicleID.xlsx'
...
carCascade = cv2.CascadeClassifier('C:\\Users\\MBA\\Desktop\\myhaar.xml')
video = cv2.VideoCapture('C:\\Users\\MBA\\Desktop\\MBa\\Internship\\Videos\\a_1.avi')
...
def detection(image_1):
    ...
    #print("Loading model")
    #filename = 'C:\\Users\\MBA\\Desktop\\MBa\\Internship\\finalized_model.sav' # write the full directory path and also put double slashes if required!
    #model = pickle.load(open(filename, 'rb'))
    #print('Model loaded. Predicting characters of number plate')
    
    #print("Loading model")
        filename = 'C:\\Users\\MBA\\Desktop\\finalized_model.sav' # write the full directory path and also put double slashes if required!
...
def trackMultipleObjects():
    ...
    out = cv2.VideoWriter('C:\\Users\\MBA\\Desktop\\outpy.avi',cv2.VideoWriter_fourcc('M','J','P','G'), 10, (WIDTH,HEIGHT))
    ...
    while True:
        ...
        if (now.hour == 0 & now.minute == 0 & now.second == 0):
            a = 1
            counter = counter + 1
            filename = 'C:\\Users\MBA\Desktop\mainFileVehicleID.xlsx'
